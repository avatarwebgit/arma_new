...
@push('script')
    ...
    <script>
                ...
                if ($(this).attr('type') == 'hidden') {
                    if ($(this).parents('.signature-pad-body').length) {
                        if ($(this).val() == "") {
                            ...
                            notifier.show('Error!', '{{ __('Please save your signature.') }}', 'danger',
                                '{{ asset('assets/images/notification/high_priority-48.png') }}', 4000);
                            check.push(false);
                        } else {
        ...
        function submitForm(formData) {
            ...
            $.ajax({
                type: "POST",
                url: '{{ route('admin.market.form.update', ['market'=>$market->id]) }}',
                data: formData,
                processData: false,
                contentType: false,
    ...
    <script>
        $(document).ready(function () {
            $('#text-1698311549814-0').parent().addClass('d-none');
            $('#text-1698310390094-0').parent().addClass('d-none');
            $('#text-1698487252965-0').parent().addClass('d-none');
            $('#radio-group-1698490396134-0_1').parent().addClass('d-none');
        })
        $('input[type=radio][name="radio-group-1698311379966-0"]').change(function () {
            let radio_value = $(this).val();
            if (radio_value == 'other') {
                $('#text-1698311549814-0').parent().removeClass('d-none');
            } else {
                $('#text-1698311549814-0').parent().addClass('d-none');
            }
        })
        $('input[type=radio][name="radio-group-1698310170278-0"]').change(function () {
            let radio_value = $(this).val();
            if (radio_value == 'other') {
                $('#text-1698310390094-0').parent().removeClass('d-none');
            } else {
                $('#text-1698310390094-0').parent().addClass('d-none');
            }
        })
        $('input[type=radio][name="radio-group-1698487026174-0"]').change(function () {
            let radio_value = $(this).val();
            if (radio_value == 'other') {
                $('#text-1698487252965-0').parent().removeClass('d-none');
            } else {
                $('#text-1698487252965-0').parent().addClass('d-none');
            }
        })
