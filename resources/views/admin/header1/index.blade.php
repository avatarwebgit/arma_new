...
@section('content')
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive py-5 pb-4">
                        <div style="padding: 5px 26px;" class="btn-group">
                            <a id="add_header1" class="btn btn-default btn-primary btn-sm no-corner " tabindex="0" aria-controls="users-table"><span><i class="ti ti-plus"></i> Create</span></a>
                        </div>
                        <div class="container-fluid">
       ...
       'class' => 'd-inline',
                                                                                        ...
                                                                                        {!! Form::close() !!}
                                                                                        <a data-action="/admin-panel/management/setting/header1/edit/{{ $item->id }}" style="margin-left: 10px" href="javascript:void(0);"
...
<script>
    $(function() {
        $('body').on('click', '#add_header1', function() {
            ...
            $.ajax({
                type: "GET",
                url: '{{ route('admin.header1.create') }}',
                data: {},
        ...
        $('body').on('click', '.edit-header1', function() {
            var action = $(this).data('action');
            var modal = $('#common_modal');
            $.get(action, function(response) {

                modal.find('.modal-title').html('{{ __('Edit Header1') }}');
                modal.find('.body').html(response.html);
