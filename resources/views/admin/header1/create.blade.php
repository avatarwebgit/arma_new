...
@section('content')
        ...
        <div class="form-group col-md-4">
            ...
            <select id="cat_id" name="cat_id" class="form-control">
                ...
                @foreach($categories as $category)
                    <option {{ $cat==$category->id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->title }}</option>
                @endforeach
            </select>
            @error('category')
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-center">
            <a href="{{ route('admin.header1.index') }}" type="button" class="btn btn-secondary" style="margin-right: 5px"
