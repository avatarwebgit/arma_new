...
@section('content')
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <input id="title_2" type="text" name="title_2" class="form-control" value="{{ old('title_2') }}">
            @error('title_2')
            <p class="input-error-validate">
                {{ $message }}
            </p>
        ...
        <div class="form-group col-md-4">
            ...
            <input id="number_1" type="text" name="number_1" class="form-control" value="{{ old('number_1') }}">
            @error('number_1')
            <p class="input-error-validate">
                {{ $message }}
            </p>
        ...
        <div class="form-group col-md-4">
            ...
            <input id="number_2" type="text" name="number_2" class="form-control" value="{{ old('number_2') }}">
            @error('number_2')
            <p class="input-error-validate">
                {{ $message }}
            </p>
        ...
        <div class="form-group col-md-4">
            ...
            <input id="number_3" type="text" name="number_3" class="form-control" value="{{ old('number_3') }}">
            @error('number_3')
            <p class="input-error-validate">
                {{ $message }}
            </p>
