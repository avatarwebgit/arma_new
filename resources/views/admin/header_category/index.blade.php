...
@section('breadcrumb')
    <div class="col-md-12 mb-3">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Header Category') }}</h4>
        </div>
    </div>
@endsection
@section('content')
                ...
                <div class="col-12">
                        <div>
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-md-12 mb-3">
                                        <a href="{{ route('admin.header_category.create') }}" class="btn btn-primary btn-sm">
                                            Create
                                        </a>
                                    </div>
                                    <div class="col-md-12">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                @foreach($categories as $key=>$item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a title="Edit" href="{{ route('admin.header_category.edit',['category'=>$item->id]) }}"
                                                            ...
                                                            {!! Form::open([
'method' => 'POST',
'route' => ['admin.header_category.remove', $item->id],
'class' => 'd-inline',
]) !!}
