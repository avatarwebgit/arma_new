...
Route::post('/daily_report_excel', [IndexController::class, 'daily_report_excel'])->name('home.daily_report.excel');

//Admin Panel Route
Route::name('admin.')->middleware('check.session')->prefix('/admin-panel/management/')->group(function () {
    Route::post('/update-password/user/reset', [UserController::class, 'updatePasswordUser'])->name('reset.password.user');
    //dashboard
