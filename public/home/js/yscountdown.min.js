...
!function (t, o) {
    ...
    "use strict";
    return function (t, o) {
        var e = {}, n = null, r = null, a = null, l = null, i = !1, s = (e.init = function (t, o) {
            if (!("addEventListener" in u)) throw"ysCountDown: This browser does not support the required JavaScript methods.";
            if (e.destroy(), n = "string" == typeof t ? new Date(t) : t, !((t = n) instanceof Date) || isNaN(t)) throw new TypeError("ysCountDown: Please enter a valid date.");
            if ("function" != typeof o) throw new TypeError("ysCountDown: Please enter a callback function.");
            r = o, s()
        }, e.destroy = function () {
            r = n = null, f(), l = null, i = !1
        },
            function () {
            a = a || setInterval(function () {
                var t, o;
                t = new Date(),
                    t.setMinutes(t.getMinutes() - 210);
                (o = Math.ceil((n.getTime() - t.getTime()) / 1e3)) <= 0 && (i = !0, f()), l = {
                    seconds: o % 60,
                    ...
                    years: Math.abs(n.getFullYear() - t.getFullYear()),
